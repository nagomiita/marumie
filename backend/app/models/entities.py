...
from .mixins import IntegerIdMixin, TimestampMixin, UUIDIdMixin
...
class PoliticalOrganization(IntegerIdMixin, TimestampMixin, Base):
    ...
    org_name: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="org_name"
    )

    balance_snapshots: Mapped[list["BalanceSnapshot"]] = relationship(
        back_populates="political_organization",
...
class Transaction(IntegerIdMixin, TimestampMixin, Base):
    __tablename__ = "transactions"

    political_organization_id: Mapped[int] = mapped_column(
        BigInteger,
        ForeignKey("political_organizations.id", ondelete="CASCADE"),
        nullable=False,
        name="political_organization_id",
    )
    transaction_no: Mapped[str] = mapped_column(
        String(255), nullable=False, name="transaction_no"
    )
    transaction_date: Mapped[date] = mapped_column(
        Date, nullable=False, name="transaction_date"
    )
    ...
    debit_account: Mapped[str] = mapped_column(
        String(255), nullable=False, name="debit_account"
    )
    debit_sub_account: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="debit_sub_account"
    )
    debit_department: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="debit_department"
    )
    debit_partner: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="debit_partner"
    )
    debit_tax_category: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="debit_tax_category"
    )
    debit_amount: Mapped[Decimal] = mapped_column(
        Numeric(15, 2), nullable=False, name="debit_amount"
    )
    credit_account: Mapped[str] = mapped_column(
        String(255), nullable=False, name="credit_account"
    )
    credit_sub_account: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="credit_sub_account"
    )
    credit_department: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="credit_department"
    )
    credit_partner: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="credit_partner"
    )
    credit_tax_category: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="credit_tax_category"
    )
    credit_amount: Mapped[Decimal] = mapped_column(
        Numeric(15, 2), nullable=False, name="credit_amount"
    )
    description: Mapped[str | None] = mapped_column(Text, nullable=True)
    memo: Mapped[str | None] = mapped_column(Text, nullable=True)
    friendly_category: Mapped[str | None] = mapped_column(
        String(255), nullable=True, name="friendly_category"
    )
    category_key: Mapped[str] = mapped_column(
        String(255), nullable=False, name="category_key"
    )
    label: Mapped[str] = mapped_column(
        String(255), nullable=False, default="", server_default="", name="label"
    )
    hash: Mapped[str] = mapped_column(
        String(255), nullable=False, default="", server_default="", name="hash"
    )

    political_organization: Mapped[PoliticalOrganization] = relationship(
...
class BalanceSnapshot(IntegerIdMixin, TimestampMixin, Base):
    ...
    snapshot_date: Mapped[date] = mapped_column(
        Date, nullable=False, name="snapshot_date"
    )
